...
internal class PriorityQueueHashSetTest {

    private lateinit var queue: PriorityQueueHashSet<Proceso>

    @BeforeEach
    fun setUp() {
        queue = PriorityQueueHashSet(listOf(proceso2, proceso, proceso3))
    }
